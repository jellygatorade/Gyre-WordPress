<?php
/*
Plugin Name: NCMA Digital Label Post Type
Description: Plugin to register the ncma-digital-label post type. Makes the ncma-digital-label post type available, creates its Advanced Custom Fields, and creates a custom endpoint for the REST API. Requires validation that selection for 'digital_label_instance' field is unique.
Version: 6.01
Author: Kevin Kane
*/
...
if( function_exists('acf_add_local_field_group') ):
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array (
            ...
            array (
                ...
                'key' => 'field_ncma_digital_label_instance',
                ...
                'required' => 1,
                'choices' => array(
                    'african-561-beer' => 'African 561 - Beer',
                    'african-561-gold' => 'African 561 - Gold',
            ...
            array (
                ...
                'key' => 'field_ncma_digital_label_attract_video_vimeo_url',
            ...
            array (
                ...
                'key' => 'field_ncma_digital_label_apply_artworks',
    ...
    /* Field group for Digital Label text content - English, Spanish */
    acf_add_local_field_group(array(
        'key' => 'digital-label-english',
        'title' => 'Digital Label - Text - English, Spanish',
        'fields' => array (
            /* English tab */
            array(
                'key' => 'field_ncma_digital_label_en_text_tab',
                'label' => 'English',
                'name' => '',
                'type' => 'tab',
                'instructions' => '',
            ...
            /*English fields*/
            array (
                'key' => 'field_ncma_digital_label_en_introductory_heading',
                'label' => 'Introductory heading (English)',
                'name' => 'en_introductory_heading',
                'type' => 'text',
                'instructions' => 'Appears on both the main menu and attract screens',
                'required' => 1,
                'conditional_logic' => 0,
            ),
            array (
                'key' => 'field_ncma_digital_label_en_introductory_text_body',
            ...
            array (
                'key' => 'field_ncma_digital_label_en_help_text',
            ...
            /* Spanish tab */
            array(
                'key' => 'field_ncma_digital_label_es_text_tab',
                'label' => 'Spanish',
                'name' => '',
                'type' => 'tab',
                'instructions' => '',
            ...
            /*Spanish fields*/
            array (
                'key' => 'field_ncma_digital_label_es_introductory_heading',
            ...
            array (
                'key' => 'field_ncma_digital_label_es_text_body',
            ...
            array (
                'key' => 'field_ncma_digital_label_es_help_text',
...
function kkane_ncma_digital_label_get_data() {
    ...
    foreach($posts as $post) {
        ...
        $data[$i]['en']['help_text'] = get_field('en_help_text', $post->ID);
        ...
        $data[$i]['es']['help_text'] = get_field('es_help_text', $post->ID);
